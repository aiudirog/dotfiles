...
# build debian package #a2# Alias for \kbd{hg-buildpackage}
...
#ps cax | grep ssh-agent > /dev/null
#if [ $? -ne 0 ]; then
...
alias viewsshlogs='journalctl -u sshd -n '
alias dis='export DISPLAY=:0'
alias watch_cpu='watch -n1 "lscpu | grep MHz"'
alias watch_cpu_temp='watch -n1 "sensors"'
alias watch_usages='watch -n1 "lscpu | grep MHz; echo; sensors; echo; free -h;"'
alias caps_lock_to_ctrl="/usr/bin/setxkbmap -option 'ctrl:nocaps'"

alias watch_a_new_hope='telnet towel.blinkenlights.nl'
alias mutt='offlineimap -o -u quiet && mutt && offlineimap -o -u quiet'

#alias KILL='sudo pkill -KILL -u roger'
alias kwin-fix='killall kwin_x11; sleep 5; export DISPLAY=:0; kwin_x11 --replace &;'
...
#alias install-f='sudo apt-fast install'
#alias in-f='sudo apt-fast install'
#alias update-f='sudo apt-fast update'

#alias install-fast='sudo apt-fast install'
#alias in-fast='sudo apt-fast install'
#alias update-fast='sudo apt-fast update'

alias right-click-scroll-on='xinput set-prop "Kensington      Kensington USB/PS2 Orbit" "libinput Scroll Method Enabled" 0 0 1; xinput set-prop "Kensington      Kensington USB/PS2 Orbit" "libinput Button Scrolling Button" 3'
alias right-click-scroll-off='xinput set-prop "Kensington      Kensington USB/PS2 Orbit" "libinput Scroll Method Enabled" 0 0 0; xinput set-prop "Kensington      Kensington USB/PS2 Orbit" "libinput Button Scrolling Button" 0'
